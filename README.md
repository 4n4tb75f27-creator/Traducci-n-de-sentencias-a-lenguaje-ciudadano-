...
| 3 | Preparación del corpus normativo de referencia | [sentencias_referencia.md](sentencias_referencia.md) | Despliegue en web |
| 4 | | | |
| 5 | | | |
...
Todo es gratuito y no exige tarjeta de crédito: Interfaz web (Streamlit) + Modelo gratuito (OpenRouter) + Corpus de sentencias.

---

## 🚀 Parte 4 — Ruta de despliegue
Despliegue gratuito en Streamlit Community Cloud o Vercel.

---

## ⚖️ Parte 5 y 6 — Ética y responsabilidad
- **Advertencia obligatoria:** *"Esta herramienta es un ejercicio académico que no constituye asesoría legal ni sustituye la consulta con un abogado."*
- **Protección de datos:** No recolecta ni almacena datos personales reales (Ley 1581 de 2012).
- **Anti-alucinación:** Admite cuando la sentencia no contiene el dato consultado.

---

## 🔍 Parte 7 y 8 — Entregables finales
- [ ] Solución funcionando desplegada con URL pública.
- [ ] Usuario real con evidencia.
- [ ] Repositorio con historial de avances al día.
